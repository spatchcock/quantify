...
Unit::NonSI.configure do
  ...
  load :name => 'british thermal unit', :physical_quantity => 'energy', :factor => 1.055056e3, :symbol => 'BTU'
  ...
  load :name => 'degree celsius', :physical_quantity => 'temperature', :scaling => 273.15, :symbol => '°C'
  load :name => 'degree farenheit', :physical_quantity => 'temperature', :factor => 5.0/9.0, :scaling => 459.67, :symbol => '°F'
  load :name => 'degree rankine', :physical_quantity => 'temperature', :factor => 5.0/9.0, :symbol => '°R'
  ...
  load :name => 'electron volt', :physical_quantity => 'energy', :factor => 160.218e-21, :symbol => 'eV'
  ...
  load :name => 'faraday', :physical_quantity => 'electric charge', :factor => 96.4853e3, :symbol => 'F'
  ...
  load :name => 'uk fluid ounce', :physical_quantity => 'volume', :factor => 28.41308e-6, :symbol => 'fl oz'
  load :name => 'us fluid ounce', :physical_quantity => 'volume', :factor => 29.57353e-6, :symbol => 'fl oz'
  load :name => 'foot', :physical_quantity => 'length', :factor => 0.3048, :symbol => 'ft'
  load :name => 'us survey foot', :physical_quantity => 'length', :factor => 304.8e-3, :symbol => 'ft'
  ...
  load :name => 'uk gallon', :physical_quantity => 'volume', :factor => 4.546092, :symbol => 'gal'
  load :name => 'us liquid gallon', :physical_quantity => 'volume', :factor => 3.785412, :symbol => 'gal'
  load :name => 'gamma', :physical_quantity => 'magnetic flux density', :factor => 1e-9, :symbol => 'γ'
  load :name => 'gauss', :physical_quantity => 'magnetic flux density', :factor => 100e-6, :symbol => 'G'
  ...
  load :name => 'metric horsepower', :physical_quantity => 'power', :factor => 735.4988, :symbol => 'hp'
  ...
  load :name => 'inch of mercury', :physical_quantity => 'pressure', :factor => 3.386389e3, :symbol => 'inHg'
  ...
  load :name => 'kilowatt hour', :physical_quantity => 'energy', :factor => 3.6e6, :symbol => 'kWh'
  load :name => 'kilogram force', :physical_quantity => 'force', :factor => 9.80665, :symbol => 'kgf'
  ...
  load :name => 'nautical mile', :physical_quantity => 'length', :factor => 1.852e3, :symbol => 'nmi'
  ...
  load :name => 'pound force', :physical_quantity => 'force', :factor => 4.448222, :symbol => 'lbf'
  ...
  load :name => 'short ton', :physical_quantity => 'mass', :factor => 907.1847, :symbol => 'US ton'
  load :name => 'long ton', :physical_quantity => 'mass', :factor => 1.016047, :symbol => 'UK ton'
  load :name => 'tonne', :physical_quantity => 'mass', :factor => 1000.0, :symbol => 't'
  load :name => 'unified atomic mass', :physical_quantity => 'mass', :factor => 1.66054e-27, :symbol => 'u'
  load :name => 'yard', :physical_quantity => 'length', :factor => 0.9144, :symbol => 'yd'
  load :name => 'year', :physical_quantity => 'time', :factor => 31557600, :symbol => 'yr'

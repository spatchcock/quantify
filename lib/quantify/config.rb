...
Unit::SI.configure do |config|
  ...
  config.load :name => 'ampere', :physical_quantity => 'electric_current', :symbol => 'A', :acts_as_surrogate => true
  config.load :name => 'amagat', :physical_quantity => 'number_density', :symbol => 'η'
  config.load :name => 'bequerel', :physical_quantity => 'radioactivity', :symbol => 'Bq'
  config.load :name => 'candela', :physical_quantity => 'luminous_intensity', :symbol => 'cd', :acts_as_surrogate => true
  config.load :name => 'coloumb', :physical_quantity => 'electric_charge', :symbol => 'C'
  # config.load :name => 'cubic_metre', :physical_quantity => 'volume', :symbol => 'm^3'
  config.load :name => 'farad', :physical_quantity => 'electrical_capacitance', :symbol => 'F'
  config.load :name => 'gray', :physical_quantity => 'radiation_absorbed_dose', :symbol => 'Gy'
  config.load :name => 'hertz', :physical_quantity => 'frequency', :symbol => 'Hz', :acts_as_surrogate => true
  config.load :name => 'henry', :physical_quantity => 'inductance', :symbol => 'H'
  config.load :name => 'joule', :physical_quantity => 'energy', :symbol => 'J', :acts_as_surrogate => true
  config.load :name => 'kelvin', :physical_quantity => 'temperature', :symbol => 'K', :acts_as_surrogate => true
  config.load :name => 'lumen', :physical_quantity => 'luminous_flux', :symbol => 'lm'
  config.load :name => 'lux', :physical_quantity => 'illuminance', :symbol => 'lx'
  config.load :name => 'metre', :physical_quantity => 'length', :symbol => 'm', :acts_as_surrogate => true
  config.load :name => 'mole', :physical_quantity => 'amount_of_substance', :symbol => 'mol', :acts_as_surrogate => true
  config.load :name => 'newton', :physical_quantity => 'force', :symbol => 'N', :acts_as_surrogate => true
  config.load :name => 'ohm', :physical_quantity => 'electric_resistance', :symbol => 'Ω'
  config.load :name => 'pascal', :physical_quantity => 'pressure', :symbol => 'Pa'
  config.load :name => 'radian', :physical_quantity => 'plane_angle', :symbol => 'rad'
  config.load :name => 'second', :physical_quantity => 'time', :symbol => 's', :acts_as_surrogate => true
  config.load :name => 'siemens', :physical_quantity => 'electric_conductance', :symbol => 'S'
  config.load :name => 'sievert', :physical_quantity => 'radiation_dose_equivalent', :symbol => 'Sv'
  # config.load :name => 'square_metre', :physical_quantity => 'area', :symbol => 'm^2'
  config.load :name => 'steridian', :physical_quantity => 'solid_angle', :symbol => 'sr'
  config.load :name => 'tesla', :physical_quantity => 'magnetic_flux_density', :symbol => 'T'
  config.load :name => 'volt', :physical_quantity => 'electric_potential_difference', :symbol => 'V'
  config.load :name => 'watt', :physical_quantity => 'power', :symbol => 'W', :acts_as_surrogate => true
  config.load :name => 'weber', :physical_quantity => 'magnetic_flux', :symbol => 'Wb'
  ...
  #
  config.load :name => 'kilogram', :physical_quantity => :mass, :symbol => 'kg'
  config.load :name => 'gram', :physical_quantity => 'mass', :factor => 1e-3, :symbol => 'g', :acts_as_surrogate => true
...
Unit::NonSI.configure do |config|
  ...
  config.load :name => 'are', :physical_quantity => 'area', :factor => 100.0, :symbol => 'a'
  config.load :name => 'astronomical unit', :physical_quantity => 'length', :factor => 149.5979e9, :symbol => 'AU', :label => 'ua'
  config.load :name => 'atmosphere', :physical_quantity => 'pressure', :factor => 101.325e3, :symbol => 'atm'
  config.load :name => 'bar', :physical_quantity => 'pressure', :factor => 100e3, :symbol => 'bar'
  ...
  config.load :name => 'curie', :physical_quantity => 'radioactivity', :factor => 37.0e9, :symbol => 'Ci'
  config.load :name => 'day', :physical_quantity => 'time', :factor => 86.4e3, :symbol => 'd'
  config.load :name => 'degree', :physical_quantity => 'plane angle', :factor => Math::PI/180.0, :symbol => '°', :label => '°'
  config.load :name => 'degree celsius', :physical_quantity => 'temperature', :scaling => 273.15, :symbol => '°C'
  config.load :name => 'degree farenheit', :physical_quantity => 'temperature', :factor => 5.0/9.0, :scaling => 459.67, :symbol => '°F'
  config.load :name => 'degree rankine', :physical_quantity => 'temperature', :factor => 5.0/9.0, :symbol => '°R'
  config.load :name => 'dram', :physical_quantity => 'length', :factor => 1.771845e-3, :symbol => 'dr av'
  config.load :name => 'dyne', :physical_quantity => 'force', :factor => 10e-6, :symbol => 'dyn'
  config.load :name => 'dyne centimetre', :physical_quantity => 'energy', :factor => 100e-9, :symbol => 'dyn cm'
  config.load :name => 'electron volt', :physical_quantity => 'energy', :factor => 160.218e-21, :symbol => 'eV'
  config.load :name => 'erg', :physical_quantity => 'energy', :factor => 100.0e-9, :symbol => 'erg'
  config.load :name => 'ell', :physical_quantity => 'length', :factor => 1.143, :symbol => 'ell'
  config.load :name => 'faraday', :physical_quantity => 'electric charge', :factor => 96.4853e3, :symbol => 'F'
  ...
  config.load :name => 'uk fluid ounce', :physical_quantity => 'volume', :factor => 28.41308e-6, :symbol => 'fl oz'
  config.load :name => 'us fluid ounce', :physical_quantity => 'volume', :factor => 29.57353e-6, :symbol => 'fl oz'
  config.load :name => 'foot', :physical_quantity => 'length', :factor => 0.3048, :symbol => 'ft'
  config.load :name => 'us survey foot', :physical_quantity => 'length', :factor => 304.8e-3, :symbol => 'ft'
  ...
  config.load :name => 'uk gallon', :physical_quantity => 'volume', :factor => 4.546092, :symbol => 'gal'
  config.load :name => 'us liquid gallon', :physical_quantity => 'volume', :factor => 3.785412, :symbol => 'gal'
  config.load :name => 'gamma', :physical_quantity => 'magnetic flux density', :factor => 1e-9, :symbol => 'γ'
  config.load :name => 'gauss', :physical_quantity => 'magnetic flux density', :factor => 100e-6, :symbol => 'G'
  ...
  config.load :name => 'grad', :physical_quantity => 'plane_angle', :factor => Math::PI/200.0, :symbol => 'grad'
  ...
  config.load :name => 'hectare', :physical_quantity => 'area', :factor => 10e3, :symbol => 'ha'
  ...
  config.load :name => 'metric horsepower', :physical_quantity => 'power', :factor => 735.4988, :symbol => 'hp'
  # config.load :name => 'uk horsepower', :physical_quantity => 'power', :factor => 745.6999, :symbol => 'hp'
  config.load :name => 'hour', :physical_quantity => 'time', :factor => 3.6e3, :symbol => 'h'
  ...
  config.load :name => 'inch', :physical_quantity => 'length', :factor => 25.4e-3, :symbol => 'in'
  config.load :name => 'inch of mercury', :physical_quantity => 'pressure', :factor => 3.386389e3, :symbol => 'inHg'
  ...
  config.load :name => 'kilowatt hour', :physical_quantity => 'energy', :factor => 3.6e6, :symbol => 'kWh'
  config.load :name => 'kilogram force', :physical_quantity => 'force', :factor => 9.80665, :symbol => 'kgf'
  config.load :name => 'knot', :physical_quantity => 'velocity', :factor => 514.4444e-3, :symbol => 'knot'
  ...
  config.load :name => 'litre', :physical_quantity => 'volume', :factor => 1e-3, :symbol => 'L'
  ...
  config.load :name => 'minute', :physical_quantity => 'time', :factor => 60.0, :symbol => 'min'
  config.load :name => 'mile', :physical_quantity => 'length', :factor => 1.609344e3, :symbol => 'mi'
  config.load :name => 'nautical mile', :physical_quantity => 'length', :factor => 1.852e3, :symbol => 'nmi'
  config.load :name => 'millibar', :physical_quantity => 'pressure', :factor => 100, :symbol => 'mbar'
  config.load :name => 'month', :physical_quantity => 'time', :factor => 2.551444e6, :symbol => 'month'
  config.load :name => 'ounce', :physical_quantity => 'mass', :factor => 28.34952e-3, :symbol => 'oz'
  config.load :name => 'point', :physical_quantity => 'length', :factor => 351.4598e-6, :symbol => 'pt', :label => 'pt'
  config.load :name => 'pound', :physical_quantity => 'mass', :factor => 0.45359237, :symbol => 'lb'
  ...
  config.load :name => 'pound force', :physical_quantity => 'force', :factor => 4.448222, :symbol => 'lbf'
  ...
  config.load :name => 'rutherford', :physical_quantity => 'radioactivity', :factor => 1e6, :symbol => 'rd'
  ...
  config.load :name => 'short ton', :physical_quantity => 'mass', :factor => 907.1847, :symbol => 'US ton'
  config.load :name => 'long ton', :physical_quantity => 'mass', :factor => 1.016047, :symbol => 'UK ton'
  config.load :name => 'tonne', :physical_quantity => 'mass', :factor => 1000.0, :symbol => 't'
  config.load :name => 'unified atomic mass', :physical_quantity => 'mass', :factor => 1.66054e-27, :symbol => 'u'
  config.load :name => 'yard', :physical_quantity => 'length', :factor => 0.9144, :symbol => 'yd'
  config.load :name => 'year', :physical_quantity => 'time', :factor => 31557600, :symbol => 'yr'
